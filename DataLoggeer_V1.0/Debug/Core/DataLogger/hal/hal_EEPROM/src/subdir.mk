...
C_SRCS += \
../Core/DataLogger/hal/hal_EEPROM/src/hal_EEPROM.c 

OBJS += \
./Core/DataLogger/hal/hal_EEPROM/src/hal_EEPROM.o 

C_DEPS += \
./Core/DataLogger/hal/hal_EEPROM/src/hal_EEPROM.d 


# Each subdirectory must supply rules for building sources it contributes
Core/DataLogger/hal/hal_EEPROM/src/%.o Core/DataLogger/hal/hal_EEPROM/src/%.su Core/DataLogger/hal/hal_EEPROM/src/%.cyclo: ../Core/DataLogger/hal/hal_EEPROM/src/%.c Core/DataLogger/hal/hal_EEPROM/src/subdir.mk
...
clean: clean-Core-2f-DataLogger-2f-hal-2f-hal_EEPROM-2f-src

clean-Core-2f-DataLogger-2f-hal-2f-hal_EEPROM-2f-src:
	-$(RM) ./Core/DataLogger/hal/hal_EEPROM/src/hal_EEPROM.cyclo ./Core/DataLogger/hal/hal_EEPROM/src/hal_EEPROM.d ./Core/DataLogger/hal/hal_EEPROM/src/hal_EEPROM.o ./Core/DataLogger/hal/hal_EEPROM/src/hal_EEPROM.su

.PHONY: clean-Core-2f-DataLogger-2f-hal-2f-hal_EEPROM-2f-src
