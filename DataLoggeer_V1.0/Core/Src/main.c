...
#ifdef EEPROM_TEST
uint8_t g_ui8ReadData=0;
uint8_t g_aui8TxBuffer[HAL_EEPROM_PAGE_SIZE] = {0};
uint8_t g_aui8RxBuffer[HAL_EEPROM_PAGE_SIZE] = {0};
uint8_t ui8I = 0;
#endif

#ifdef USB_TEST
uint8_t g_ui8usbReadBuffer[64];
uint8_t tmpUsbReadBuffer[64]={0};
uint8_t g_usbReadBuffer[64] = {0};
#endif
