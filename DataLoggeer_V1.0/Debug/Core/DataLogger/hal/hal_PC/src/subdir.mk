...
C_SRCS += \
../Core/DataLogger/hal/hal_PC/src/hal_PC.c 

OBJS += \
./Core/DataLogger/hal/hal_PC/src/hal_PC.o 

C_DEPS += \
./Core/DataLogger/hal/hal_PC/src/hal_PC.d 


# Each subdirectory must supply rules for building sources it contributes
Core/DataLogger/hal/hal_PC/src/%.o Core/DataLogger/hal/hal_PC/src/%.su Core/DataLogger/hal/hal_PC/src/%.cyclo: ../Core/DataLogger/hal/hal_PC/src/%.c Core/DataLogger/hal/hal_PC/src/subdir.mk
...
clean: clean-Core-2f-DataLogger-2f-hal-2f-hal_PC-2f-src

clean-Core-2f-DataLogger-2f-hal-2f-hal_PC-2f-src:
	-$(RM) ./Core/DataLogger/hal/hal_PC/src/hal_PC.cyclo ./Core/DataLogger/hal/hal_PC/src/hal_PC.d ./Core/DataLogger/hal/hal_PC/src/hal_PC.o ./Core/DataLogger/hal/hal_PC/src/hal_PC.su

.PHONY: clean-Core-2f-DataLogger-2f-hal-2f-hal_PC-2f-src
