...
C_SRCS += \
../Core/DataLogger/app/app_callback/appcb_GPIO/src/appcb_GPIO.c 

OBJS += \
./Core/DataLogger/app/app_callback/appcb_GPIO/src/appcb_GPIO.o 

C_DEPS += \
./Core/DataLogger/app/app_callback/appcb_GPIO/src/appcb_GPIO.d 


# Each subdirectory must supply rules for building sources it contributes
Core/DataLogger/app/app_callback/appcb_GPIO/src/%.o Core/DataLogger/app/app_callback/appcb_GPIO/src/%.su Core/DataLogger/app/app_callback/appcb_GPIO/src/%.cyclo: ../Core/DataLogger/app/app_callback/appcb_GPIO/src/%.c Core/DataLogger/app/app_callback/appcb_GPIO/src/subdir.mk
...
clean: clean-Core-2f-DataLogger-2f-app-2f-app_callback-2f-appcb_GPIO-2f-src

clean-Core-2f-DataLogger-2f-app-2f-app_callback-2f-appcb_GPIO-2f-src:
	-$(RM) ./Core/DataLogger/app/app_callback/appcb_GPIO/src/appcb_GPIO.cyclo ./Core/DataLogger/app/app_callback/appcb_GPIO/src/appcb_GPIO.d ./Core/DataLogger/app/app_callback/appcb_GPIO/src/appcb_GPIO.o ./Core/DataLogger/app/app_callback/appcb_GPIO/src/appcb_GPIO.su

.PHONY: clean-Core-2f-DataLogger-2f-app-2f-app_callback-2f-appcb_GPIO-2f-src
